  ...
  return (
    <div id="about" className="w-[1200px] mx-auto my-10 px-4 flex justify-center items-center">
      <div className="w-1/2 pr-4">
        <span className="w-full mb-2 block text-xl text-yellow-400 dark:text-blue-400">I’m a Front End Developer</span>
        <h4 className="w-full block text-3xl mb-4 font-medium dark:text-white">Why Hire Me For Your Next Project?</h4>
        ...
        <Link className="inline-block rounded-full mt-4 py-4 px-6 text-lg bg-yellow-400 text-white font-['Jost'] dark:bg-blue-400" to="/experience">CV Download</Link>
      </div>
      <div className="w-1/2">
